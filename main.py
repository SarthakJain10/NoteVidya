...
os.environ['STREAMLIT_SERVER_FILE_WATCHER_TYPE'] = 'none'  # Disables hot-reload
...
if analyze_btn and video_url:
    try:
        ...
        /* Add a subtle shadow below the tab bar */
        ...
        with tabs[0]:
            ...
            # API + Local Fallback
            try:
                transcript = transcript_generator.get_youtube_transcript(video_id, 'sd_e74f1b000fa15e5f14002ee89cc9610f')
        ...
        with tabs[2]:
            ...
            transcript = st.session_state.tst  
